...
func scrapeStocks(ticker string, c *colly.Collector, stocks *[]Stock) {
	...
	cc.OnHTML("div.container section", func(e *colly.HTMLElement) {
		stock := Stock{
			Company: ticker, // Use the ticker as the company identifier since it's not clearly present in HTML
